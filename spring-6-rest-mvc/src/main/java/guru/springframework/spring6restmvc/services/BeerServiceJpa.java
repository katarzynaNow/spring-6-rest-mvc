...
public class BeerServiceJpa implements BeerService {
    ...
    public Page<BeerDTO> listBeers(String beerName, BeerStyle beerStyle, Boolean showInventory,
        ...
        PageRequest pageRequest = buildPageResults(pageNumber, pageSize);
    ...
    public PageRequest buildPageResults(Integer pageNumber, Integer pageSize){
        int queryPageNumber;
        int queryPageSize;
    ...
    private Page<Beer> listBeersByNameAndStyle(String beerName, BeerStyle beerStyle, Pageable pageable) {
        return beerRepository.findAllByBeerNameIsLikeIgnoreCaseAndAndBeerStyle("%" + beerName + "%",
                beerStyle, pageable);
    }
